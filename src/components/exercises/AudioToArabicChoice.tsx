...
export function AudioToArabicChoice({ audioUrl, correctArabic, options, onResult }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <p className="text-sm text-muted-foreground font-medium">Listen and choose the word</p>
