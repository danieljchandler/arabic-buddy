    ...
    return (
      <AppShell compact>
        ...
        <div className="text-center max-w-sm mx-auto py-12">
          ...
          <p className="text-muted-foreground mb-8">Sign in to review your vocabulary.</p>
    ...
    return (
      <AppShell compact>
        ...
        <div className="text-center max-w-sm mx-auto py-12">
          ...
          {sessionStats.total === 0 && (
            <p className="text-muted-foreground mb-8">No words due right now. Come back later!</p>
          )}
  ...
  return (
    <AppShell compact>
      ...
      <div className="py-4 max-w-sm mx-auto">
        ...
        {/* Fallback: if exercise requires audio but no audio_url */}
        {currentExercise === 'audio_to_arabic' && !currentCard.audio_url && (
          <ArabicToEnglishChoice
            key={currentCard.id}
            wordArabic={currentCard.word_arabic}
