        ...
        {visible.map((t) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group w-full p-4 rounded-2xl bg-card border border-plum/12",
                "flex items-center gap-3.5 text-left shadow-card-soft",
                "transition-all duration-200",
                "hover:border-plum/30 hover:shadow-elegant hover:-translate-y-px",
            ...
            >
              ...
              <ChevronRight className="h-4 w-4 text-plum/40 shrink-0 transition-transform group-hover:translate-x-0.5 group-hover:text-plum/70" />
            </button>
          );
        })}
      </div>
