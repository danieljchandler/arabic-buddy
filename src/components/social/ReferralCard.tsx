...
export function ReferralCard() {
  ...
  const shareText = (i: ReferralInfo) =>
    i.rewards_enabled
      ? `I'm learning spoken Arabic on Hikaya — join with my code ${i.code} and your first month is free: https://hakiya.app/?ref=${i.code}`
      : `I'm learning spoken Arabic on Hikaya — join me with my code ${i.code}: https://hakiya.app/?ref=${i.code}`;
