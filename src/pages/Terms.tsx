  ...
  return (
    <AppShell>
      ...
      <article className="prose prose-sm sm:prose max-w-none">
        ...
        <p>
          Welcome to Hikaya. By creating an account or using this site you agree to
          these terms. They're written in plain English on purpose.
        </p>

        <h2>What Hikaya is</h2>
        <p>
          Hikaya is an Arabic-learning web app focused on spoken dialects (Gulf,
        ...
        <h2>Your content</h2>
        <p>
          You keep ownership of audio, text, or media you upload. You grant Hikaya a
        ...
        <p>
          ...
          Hikaya — including training or fine-tuning speech and language models.
        </p>
        <p>
        ...
        <p>
          Hikaya uses AI models to generate translations, explanations, images, audio,
        ...
        <p>
          To the maximum extent allowed by law, Hikaya's liability for any claim
        ...
        <p>
          ...
          app or by email. Continuing to use Hikaya after a change means you accept
          the new terms.
        </p>
