...
export function ArabicToEnglishChoice({ wordArabic, correctEnglish, options, onResult }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <p className="text-sm text-muted-foreground font-medium">What does this word mean?</p>

      <p
        className="text-4xl font-bold text-foreground font-arabic"
        dir="rtl"
      >
        {wordArabic}
      </p>
      ...
      <div className="grid grid-cols-1 gap-3 w-full max-w-sm">
        {options.map((option) => {
          const isCorrectAnswer = option === correctEnglish;
          ...
          return (
            <button
              ...
              className={cn(
                "p-4 rounded-xl border-2 text-base font-medium text-left transition-all duration-200",
