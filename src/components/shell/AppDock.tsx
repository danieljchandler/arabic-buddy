 ...
 * from forty pixels below the floating Ask AI disc — the same verb twice, in
 * the two spots a thumb rests. The disc survives (AskAiFab), but it clears
 * this bar now: above it until lg, and in the corner the left rail leaves
 * free from lg up — its first life ended for covering the Review due count.
 * The dock ends the way every feed app this audience uses ends: your picture,
