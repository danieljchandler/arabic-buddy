 ...
 * does not get: when something is waiting, the desert-red ring lights up and
  ...
  return (
    ...
    >
      {hasNews && (
        <span
          aria-hidden
          className="absolute inset-0 rounded-xl ring-2 ring-primary ring-offset-2 ring-offset-transparent"
        />
      )}
      <img
