...
import { Loader2, LogOut, BookOpen, Plus, Settings, Mic, PlayCircle, Upload, GraduationCap, Sparkles, BookMarked, TrendingUp, Image as ImageIcon, Laugh, MessageCircle, Languages, Activity, AlertTriangle, Ticket, Clapperboard, Antenna, CheckCheck, ShieldCheck, Rss, KeyRound } from 'lucide-react';
        ...
        <div className={`grid grid-cols-1 ${isAdmin ? 'md:grid-cols-2' : ''} gap-4 mb-8`}>
          {isAdmin && (
            <>
              ...
              <Card className="cursor-pointer hover:shadow-elegant transition-shadow border-cyan-500/30" onClick={() => navigate('/admin/channels')}>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    <div className="bg-cyan-500/10 rounded-full p-4">
                      <Antenna className="h-8 w-8 text-cyan-600" />
                    </div>
                    <div>
                      <h3 className="font-semibold text-lg">Clip Channels</h3>
                      <p className="text-muted-foreground">Vet the dialect channel corpus the clip pipeline mines</p>
                    </div>
                  </div>
                </CardContent>
              </Card>

              <Card className="cursor-pointer hover:shadow-elegant transition-shadow border-cyan-500/30" onClick={() => navigate('/admin/clips')}>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    <div className="bg-cyan-500/10 rounded-full p-4">
                      <Clapperboard className="h-8 w-8 text-cyan-600" />
                    </div>
                    <div>
              ...
              <Card
                ...
                onClick={() => navigate('/admin/social-trends')}
              >
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">Social Trends</h3>
                      <p className="text-muted-foreground">Harvest X trends, Telegram & Reddit posts, and review what gets approved</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="cursor-pointer hover:shadow-elegant transition-shadow border-primary/30" onClick={() => navigate('/admin/id-logins')}>
                <CardContent className="pt-6">
                  <div className="flex items-center gap-4">
                    <div className="bg-primary/10 rounded-full p-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">ID Logins</h3>
                      <p className="text-muted-foreground">Give a reviewer an ID number and password when there's no email address to invite</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
